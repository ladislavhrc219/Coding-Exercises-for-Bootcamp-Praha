...
document.addEventListener('DOMContentLoaded', () => {
  const htmlBody = document.querySelector('.snail-racer');
  const snail1 = new Snail(1, 1, 'snail__body2');
  snail1.mount(htmlBody);
 

  const snail2 = new Snail(2,4, "snail__body3");
  snail2.mount(htmlBody);
  const snail3 = new Snail(2,4, "snail__body4");
  snail3.mount(htmlBody);

  // document.addEventListener ('click', () => {

  // }
  // for(let i = 0; i< 23; i++){
  //   const snail1 = new Snail(1, 22, 'yellow');
  //  snail1.mount(htmlBody);
  // }
})
