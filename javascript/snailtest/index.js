...
document.addEventListener ('DOMContentLoaded', () => {
  const containerDiv = document.querySelector('.snail-racer');
  const snail1 = new Snail(2,3,"color");
  snail1.mount(containerDiv);


  // const containerDiv = document.querySelector('.snail-racer');
  const snail2 = new Snail(2,3,"snail__body1");
  snail2.mount(containerDiv);
})
